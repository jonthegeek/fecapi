...
#' @return BKTODO: Return descriptions are not yet implemented in beekeeper
#' @export
fec_get_audit_category <- function(sort_nulls_last, page, primary_category_name, sort_hide_null, primary_category_id, sort_null_only, per_page, sort, api_key = Sys.getenv("FEC_API_KEY", unset = "DEMO_KEY")) {
  fec_call_api(
    path = "/audit-category/",
    method = "get",
    api_key = api_key,
...
#' @return BKTODO: Return descriptions are not yet implemented in beekeeper
#' @export
fec_get_audit_primary_category <- function(sort_nulls_last, page, primary_category_name, sort_hide_null, primary_category_id, sort_null_only, per_page, sort, api_key = Sys.getenv("FEC_API_KEY", unset = "DEMO_KEY")) {
  fec_call_api(
...
#' @return BKTODO: Return descriptions are not yet implemented in beekeeper
#' @export
fec_get_names_audit_candidates <- function(q, api_key = Sys.getenv("FEC_API_KEY", unset = "DEMO_KEY")) {
  fec_call_api(
...
#' @return BKTODO: Return descriptions are not yet implemented in beekeeper
#' @export
fec_get_names_audit_committees <- function(q, api_key = Sys.getenv("FEC_API_KEY", unset = "DEMO_KEY")) {
  fec_call_api(
